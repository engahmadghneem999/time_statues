...
import 'package:time_status/view/chatting/screens/main_chat_screen/main_chat_screen.dart';
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Icon(
                            Icons.home,
                            color: _selectedIndex == 0 ? AppColor.oranegapp : Colors.black38,
                          ),
                          CustomText(
                            text: 'Home',
                            fontWeight: FontWeight.bold,
                            fontSize: 12,
                            color: _selectedIndex == 0 ? AppColor.oranegapp : AppColor.grayColor,
                          )
                        ],
                      ),
                    ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Icon(
                            Icons.map,
                            color: _selectedIndex == 1 ? AppColor.oranegapp : Colors.black38,
                          ),
                          CustomText(
                            text: 'Map',
                            fontWeight: FontWeight.bold,
                            fontSize: 12,
                            color: _selectedIndex == 1 ? AppColor.oranegapp : AppColor.grayColor,
                          )
                        ],
                      ),
                    ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Icon(
                            Icons.chat,
                            color: _selectedIndex == 2 ? AppColor.oranegapp : Colors.black38,
                          ),
                          CustomText(
                            text: 'Chat',
                            fontWeight: FontWeight.bold,
                            fontSize: 12,
                            color: _selectedIndex == 2 ? AppColor.oranegapp : AppColor.grayColor,
                          )
                        ],
                      ),
                    ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Icon(
                            Icons.group,
                            color: _selectedIndex == 3 ? AppColor.oranegapp : Colors.black38,
                          ),
                          CustomText(
                            text: 'Task',
                            fontWeight: FontWeight.bold,
                            fontSize: 12,
                            color: _selectedIndex == 3 ? AppColor.oranegapp : AppColor.grayColor,
                          )
                        ],
                      ),
                    ),
