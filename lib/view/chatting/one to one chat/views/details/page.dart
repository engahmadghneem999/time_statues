...
import 'package:time_status/view/chatting/one%20to%20one%20chat/views/details/widgets/action.dart';
import 'package:time_status/view/chatting/one%20to%20one%20chat/views/details/widgets/category.dart';
...
class DetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppColor.fromHex('#ECE9FF'),
      body: Stack(
        children: [
          Stack(
