                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ElevatedButton(
                                        onPressed: () {
                                          controller.setActiveButton('day');
                                      ...
                                      ElevatedButton(
                                        onPressed: () {
                                          controller.setActiveButton('week');
                                          controller.fetchGraphData();
                                        },
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: controller.activeButton ==
                                      ...
                                      ElevatedButton(
                                        onPressed: () {
                                          controller.setActiveButton('month');
                                          controller.fetchGraphData();
                                        },
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: controller.activeButton ==
                                      ...
                                      ElevatedButton(
                                        onPressed: () {
                                          controller.setActiveButton('year');
                                          controller.fetchGraphData();
                                        },
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: controller.activeButton ==
                                ...
                                Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      child: Card(
                                        color: Colors
                                            .blue, // Set the background color of the card
                                        shape: RoundedRectangleBorder(
                                          borderRadius: BorderRadius.circular(
                                              10), // Set the border radius
                                        ),
                                    ...
                                    InkWell(
                                      ...
                                      child: Card(
                                        color: Colors
                                            .green, // Set the background color of the card
                                        shape: RoundedRectangleBorder(
                                          borderRadius: BorderRadius.circular(
                                              10), // Set the border radius
                                        ),
