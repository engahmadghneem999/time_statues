...
import 'package:time_status/view/login/screen/login_screen.dart';
                                    ...
                                    child: CustomElevatedButton(
                                      ...
                                      onPressed: () async {
                                        if (formKey.currentState!.validate()) {
                                          ...
                                          print(
                                              "password.text=${controller.email.text}");
                                          print(
                                              "password.text=${controller.phoneNumber.text}");
                                          controller.signUp();
                                          print('success from signUp screen');
                                        }
                                      },
                                    ),
                                  ),
